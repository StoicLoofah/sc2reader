    ...
    def __call__(self, data, replay):
        ...
        result = dict(
            ...
            game_description=dict(
                ...
                has_non_blizzard_extension_mod=data.read_bool() if replay.base_build >= 42932 else None,
            ...
            lobby_state=dict(
                ...
                slots=[dict(
                    ...
                    commander_mastery_talents=[data.read_uint32() for i in range(data.read_bits(3))] if replay.base_build >= 42932 else [],
