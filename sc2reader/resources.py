...
class Replay(Resource):
    ...
    def register_default_readers(self):
        ...
        self.register_reader('replay.game.events', readers.GameEventsReader_38996(), lambda r: 38996 <= r.base_build < 41743)
        self.register_reader('replay.game.events', readers.GameEventsReader_41743(), lambda r: 41743 <= r.base_build)
